...
<div class="col-xl-8 stretch-card grid-margin">
    ...
    <img src="{{asset('assets/images/dashboard/banner.jpg')}}" alt="banner" class="img-fluid" />
        ...
        <div class="card-body">
            ...
            <div
                ...
                <div class="rotate-img">
                    <img src="{{asset('assets/images/dashboard/home_1.jpg')}}" alt="thumb"
            ...
            <div
                ...
                <div class="rotate-img">
                    <img src="{{asset('assets/images/dashboard/home_2.jpg')}}" alt="thumb"
                        class="img-fluid img-lg" />
                </div>
            </div>
            ...
            <div class="d-flex pt-4 align-items-center justify-content-between">
                ...
                <div class="rotate-img">
                    <img src="{{asset('assets/images/dashboard/home_3.jpg')}}" alt="thumb"
                        class="img-fluid img-lg" />
                </div>
            </div>
        </div>
